...
void bookHistograms()
{
	...
	hPairCosThetaInvMPt = new TH3F("hPairCosThetaInvMPt","hPairCosThetaInvMPt",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtBG= new TH3F("hPairCosThetaInvMPtBG","hPairCosThetaInvMPtBG",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtBG_LSNeg= new TH3F("hPairCosThetaInvMPtBG_LSNeg","hPairCosThetaInvMPtBG_LSNeg",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtBG_LSPos= new TH3F("hPairCosThetaInvMPtBG_LSPos","hPairCosThetaInvMPtBG_LSPos",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtBG_MixULS= new TH3F("hPairCosThetaInvMPtBG_MixULS","hPairCosThetaInvMPtBG_MixULS",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtBG_MixLSPos= new TH3F("hPairCosThetaInvMPtBG_MixLSPos","hPairCosThetaInvMPtBG_MixLSPos",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtBG_MixLSNeg= new TH3F("hPairCosThetaInvMPtBG_MixLSNeg","hPairCosThetaInvMPtBG_MixLSNeg",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtCS= new TH3F("hPairCosThetaInvMPtCS","hPairCosThetaInvMPtCS",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtCSBG= new TH3F("hPairCosThetaInvMPtCSBG","hPairCosThetaInvMPtCSBG",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtCSBG_LSNeg= new TH3F("hPairCosThetaInvMPtCSBG_LSNeg","hPairCosThetaInvMPtCSBG_LSNeg",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtCSBG_LSPos= new TH3F("hPairCosThetaInvMPtCSBG_LSPos","hPairCosThetaInvMPtCSBG_LSPos",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtCSBG_MixULS= new TH3F("hPairCosThetaInvMPtCSBG_MixULS","hPairCosThetaInvMPtCSBG_MixULS",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtCSBG_MixLSPos= new TH3F("hPairCosThetaInvMPtCSBG_MixLSPos","hPairCosThetaInvMPtCSBG_MixLSPos",20,-1,1,150,0,3,25,0,5);
	hPairCosThetaInvMPtCSBG_MixLSNeg= new TH3F("hPairCosThetaInvMPtCSBG_MixLSNeg","hPairCosThetaInvMPtCSBG_MixLSNeg",20,-1,1,150,0,3,25,0,5);

	hPairPhiInvMPt = new TH3F("hPairPhiInvMPt","hPairPhiInvMPt",40,-TMath::Pi(),TMath::Pi(),150,0,3,25,0,5);
	hPairPhiInvMPtBG = new TH3F("hPairPhiInvMPtBG","hPairPhiInvMPtBG",40,-TMath::Pi(),TMath::Pi(),150,0,3,25,0,5);
	hPairPhiInvMPtBG_LSNeg= new TH3F("hPairPhiInvMPtBG_LSNeg","hPairPhiInvMPtBG_LSNeg",20,-1,1,150,0,3,25,0,5);
	hPairPhiInvMPtBG_LSPos= new TH3F("hPairPhiInvMPtBG_LSPos","hPairPhiInvMPtBG_LSPos",20,-1,1,150,0,3,25,0,5);
	hPairPhiInvMPtBG_MixULS= new TH3F("hPairPhiInvMPtBG_MixULS","hPairPhiInvMPtBG_MixULS",20,-1,1,150,0,3,25,0,5);
	hPairPhiInvMPtBG_MixLSPos= new TH3F("hPairPhiInvMPtBG_MixLSPos","hPairPhiInvMPtBG_MixLSPos",20,-1,1,150,0,3,25,0,5);
	hPairPhiInvMPtBG_MixLSNeg= new TH3F("hPairPhiInvMPtBG_MixLSNeg","hPairPhiInvMPtBG_MixLSNeg",20,-1,1,150,0,3,25,0,5);
	hPairPhiInvMPtCS = new TH3F("hPairPhiInvMPtCS","hPairPhiInvMPtCS",40,-TMath::Pi(),TMath::Pi(),150,0,3,25,0,5);
	hPairPhiInvMPtCSBG = new TH3F("hPairPhiInvMPtCSBG","hPairPhiInvMPtCSBG",40,-TMath::Pi(),TMath::Pi(),150,0,3,25,0,5);
	hPairPhiInvMPtCSBG_LSNeg= new TH3F("hPairPhiInvMPtCSBG_LSNeg","hPairPhiInvMPtCSBG_LSNeg",20,-1,1,150,0,3,25,0,5);
	hPairPhiInvMPtCSBG_LSPos= new TH3F("hPairPhiInvMPtCSBG_LSPos","hPairPhiInvMPtCSBG_LSPos",20,-1,1,150,0,3,25,0,5);
	hPairPhiInvMPtCSBG_MixULS= new TH3F("hPairPhiInvMPtCSBG_MixULS","hPairPhiInvMPtCSBG_MixULS",20,-1,1,150,0,3,25,0,5);
	hPairPhiInvMPtCSBG_MixLSPos= new TH3F("hPairPhiInvMPtCSBG_MixLSPos","hPairPhiInvMPtCSBG_MixLSPos",20,-1,1,150,0,3,25,0,5);
	hPairPhiInvMPtCSBG_MixLSNeg= new TH3F("hPairPhiInvMPtCSBG_MixLSNeg","hPairPhiInvMPtCSBG_MixLSNeg",20,-1,1,150,0,3,25,0,5);
