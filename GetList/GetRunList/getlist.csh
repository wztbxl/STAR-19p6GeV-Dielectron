...
get_file_list.pl -keys "path,filename" -delim "/" -cond "production=P23ia,trgsetupname=production_9p2GeV_2020,filetype=daq_reco_picoDst,filename~st_physics,storage=NFS"  -o Run21_9p2GeV_2020_pico_a.list -limit 0
